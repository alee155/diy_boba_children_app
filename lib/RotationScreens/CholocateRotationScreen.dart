...
class ChocolateRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const ChocolateRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _ChocolateRotationScreenState createState() =>
      _ChocolateRotationScreenState();
}

class _ChocolateRotationScreenState extends State<ChocolateRotationScreen>
