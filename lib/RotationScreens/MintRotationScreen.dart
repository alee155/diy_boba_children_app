...
class MintRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const MintRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _MintRotationScreenState createState() => _MintRotationScreenState();
}

class _MintRotationScreenState extends State<MintRotationScreen>
  ...
  Color buttonColor = Colors.green; // Added state for button color
