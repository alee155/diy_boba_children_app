...
class GuavaRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const GuavaRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _GuavaRotationScreenState createState() => _GuavaRotationScreenState();
}

class _GuavaRotationScreenState extends State<GuavaRotationScreen>
