...
class BananaRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const BananaRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _BananaRotationScreenState createState() => _BananaRotationScreenState();
}

class _BananaRotationScreenState extends State<BananaRotationScreen>
  ...
  void initState() {
    ...
    _audioPlayer.open(
      Audio('assets/images/music1.mp3'),
