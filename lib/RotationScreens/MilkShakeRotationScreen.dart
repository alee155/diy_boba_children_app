...
class MilkShakeRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const MilkShakeRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _MilkShakeRotationScreenState createState() =>
      _MilkShakeRotationScreenState();
}

class _MilkShakeRotationScreenState extends State<MilkShakeRotationScreen>
