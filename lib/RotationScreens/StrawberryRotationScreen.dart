...
class StrawberryRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const StrawberryRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _StrawberryRotationScreenState createState() =>
      _StrawberryRotationScreenState();
}

class _StrawberryRotationScreenState extends State<StrawberryRotationScreen>
