...
class MangoRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const MangoRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _MangoRotationScreenState createState() => _MangoRotationScreenState();
}

class _MangoRotationScreenState extends State<MangoRotationScreen>
