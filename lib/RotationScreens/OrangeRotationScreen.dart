...
class OrangeRotationScreen extends StatefulWidget {
  final List<String> selectedImageAssets;

  const OrangeRotationScreen({Key? key, required this.selectedImageAssets})
      : super(key: key);

  @override
  _OrangeRotationScreenState createState() => _OrangeRotationScreenState();
}

class _OrangeRotationScreenState extends State<OrangeRotationScreen>
