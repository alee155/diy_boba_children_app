import 'package:diy_boba/RotationScreens/CholocateRotationScreen.dart';
import 'package:flutter/material.dart';

import '../BackgroundSelectionScreen/ImageSelectionScreen.dart';

class Cholocate extends StatefulWidget {
  const Cholocate({Key? key}) : super(key: key);

  @override
  _CholocateState createState() => _CholocateState();
}

class _CholocateState extends State<Cholocate> {
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChocolateRotationScreen(
